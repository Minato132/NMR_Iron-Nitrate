...
data = data.loc[data['amp'] > .228]
data = data.loc[data['time'] > .00078]
data['time'] = data['time'] * 1000

data = data.loc[[260, 361, 461, 561, 661, 762, 860, 962, 1060, 1162], :]
...
def t2p(ar1, ar2, ar3):
	...
	plt.plot(ar1, T2p(ar1, *a), label = 'Fitted Curve')
	plt.xlabel('Time')
